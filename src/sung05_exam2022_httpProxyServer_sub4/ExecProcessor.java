...
public class ExecProcessor extends Thread {
	...
	public void run(){
		...
		String conf = textFileIo.readFile(".//src//sung05_exam2022_httpProxyServer_sub4//"+ line);
	...
	public void proxyProcess(String cmd, String path) {
		Map<String, Object> map = textFileIo.getMapFile(".//src//sung05_exam2022_httpProxyServer_sub4//"+ cmd);
		String cmd2 = (String) map.get(path);
		if(cmd2.startsWith("Proxy-")) {
			proxyProcess(cmd2, path);
		} else if(cmd2.startsWith("Service-")){
			textFileIo.printFile(".//src//sung05_exam2022_httpProxyServer_sub4//"+ cmd2);
		}
	}
